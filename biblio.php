...
<center><font face="Britannic Bold" color="#457B9D"><h1 align="center">Tabel Data Bibliografi</h1></font></center>
<div class="container">
	<div class="row">
		<div class="col-lg-12 mt-2 mb-2" style="min-height: 530px;">
			<div class="card">
			  ...
			  <div class="card-body">
				<div class="row">
					<div class="col">
						<a href="tambah_biblio.php" class="btn btn-primary">Tambah Koleksi</a>
					</div>
					<div class="col mb-3">
							    ...
							    <tbody>
									...
									?>
										<tr>
											...
											<td align="center">
												&nbsp;&nbsp;
												<a href="hapus_biblio.php?id=<?php echo $data['id'] ?>" onclick="return confirm('Anda yakin akan menghapus data?')"><input type="submit" class="btn btn-warning" value="Delete"></a>
											</td>
										</tr>
									<?php
									endforeach;
